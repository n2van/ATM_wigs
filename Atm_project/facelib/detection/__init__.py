...
def init_retinaface_model(model_name, half=False, device='cuda'):
    if model_name == 'retinaface_resnet50':
        ...
        model_url = 'https://huggingface.co/VanNguyen1214/models_swap_face/resolve/main/detection_Resnet50_Final.pth'
    elif model_name == 'retinaface_mobile0.25':
        model = RetinaFace(network_name='mobile0.25', half=half)
        model_url = 'https://huggingface.co/VanNguyen1214/models_swap_face/resolve/main/detection_mobilenet0.25_Final.pth'
    else:
        raise NotImplementedError(f'{model_name} is not implemented.')
...
def init_yolov5face_model(model_name, device='cuda'):
    if model_name == 'YOLOv5l':
        ...
        model_url = 'https://huggingface.co/VanNguyen1214/models_swap_face/resolve/main/yolov5l-face.pth'
    elif model_name == 'YOLOv5n':
        model = YoloDetector(config_name='facelib/detection/yolov5face/models/yolov5n.yaml', device=device)
        model_url = 'https://huggingface.co/VanNguyen1214/models_swap_face/resolve/main/yolov5n-face.pth'
    else:
        raise NotImplementedError(f'{model_name} is not implemented.')
