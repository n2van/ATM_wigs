...
def init_parsing_model(model_name='bisenet', half=False, device='cuda'):
    if model_name == 'bisenet':
        ...
        model_url = 'https://huggingface.co/VanNguyen1214/models_swap_face/resolve/main/parsing_bisenet.pth'
    elif model_name == 'parsenet':
        model = ParseNet(in_size=512, out_size=512, parsing_ch=19)
        model_url = 'https://huggingface.co/VanNguyen1214/models_swap_face/resolve/main/parsing_parsenet.pth'
    else:
